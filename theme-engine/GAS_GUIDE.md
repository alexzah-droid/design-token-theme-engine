...
- minimal.bundle.css       — минималистичная, светлая
- minimal.dark.bundle.css  — минималистичная, тёмная
...
- minimal.bundle.css        — минималистичная (light)
- minimal.dark.bundle.css   — минималистичная (dark)
...
| `minimal` | Минималистичная (+ dark mode) |
