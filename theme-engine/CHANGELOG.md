...
### Changed
- **Corporate theme** — palette refreshed: green primary `#17311F`, gold accent `#B08A3E`, parchment background `#F6F2EA`. Dark mode inverts to gold primary `#B08A3E` on deep green `#0E1A13`
