...
- 70+ готовых CSS-классов компонентов без зависимостей от фреймворков
...
70+ классов: кнопки, карточки, формы, навигация, таблицы (включая expandable row), badges, переключатели, вкладки, аккордеоны, дропдауны, прогресс-бары, KPI, чипы, графики (sparkline, area, bar, donut, heatmap, gantt), date picker и утилиты типографики.
